    ...
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          ...
          >
            <span style={{ fontStyle: 'normal' }}>Bring your</span><span style={{ fontStyle: 'normal' }}>{' '}</span>
            <span
              style={{ background: `linear-gradient(90deg, ${palette.accentSoft}, ${palette.accent})`, WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}
            >
              favorite agent.
            </span>
          </h2>
